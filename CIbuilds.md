...
repositories:
  ...
  src/carma-cohda-dsrc-driver:
    type: git
    url: git@github.com:usdot-fhwa-stol/carma-cohda-dsrc-driver.git
    version: develop
  src/carma-config:
    type: git
    url: git@github.com:usdot-fhwa-stol/carma-config.git
    version: develop
  src/carma-delphi-esr-driver:
    type: git
    url: git@github.com:usdot-fhwa-stol/carma-delphi-esr-driver.git
    version: develop
  src/carma-delphi-srr2-driver:
    type: git
    url: git@github.com:usdot-fhwa-stol/carma-delphi-srr2-driver.git
    version: develop
  ...
  src/carma-msgs:
    type: git
    url: git@github.com:usdot-fhwa-stol/carma-msgs.git
    version: develop
  src/carma-platform:
    type: git
  ...
  src/carma-ssc-interface-wrapper:
    type: git
    url: git@github.com:usdot-fhwa-stol/carma-ssc-interface-wrapper.git
    version: develop
  src/carma-utils:
    type: git
    url: git@github.com:usdot-fhwa-stol/carma-utils.git
    version: develop
  src/carma-vehicle-model-framework:
    type: git
    url: git@github.com:usdot-fhwa-stol/carma-vehicle-model-framework.git
    version: develop
  src/carma-velodyne-lidar-driver:
    type: git
    url: git@github.com:usdot-fhwa-stol/carma-velodyne-lidar-driver.git
    version: develop
  src/carma-web-ui:
    type: git
  ...
  src/opendrive2lanelet:
    type: git
    url: git@github.com:usdot-fhwa-stol/opendrive2lanelet.git
    version: develop
